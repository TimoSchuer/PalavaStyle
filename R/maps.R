...
#'
#' # Grundkarte erweitert mit Gemeinden
#' grundkarte_nrw() +
...
#'           size = 0.2)
#'
#' # Grundkarte mit Daten und PALAVA-Styling
#' grundkarte_nrw(bg = "#f0efec") +
#'   geom_sf(data = nrwGemPoints,
#'           aes(color = AGS),
#'           size = 1) +
...
#'
#' # Voronoi-Karte mit Daten und PALAVA-Styling
#' grundkarte_nrw_voronoi(voronoi_fill = "white") +
#'   geom_sf(data = nrwGemPoints,
#'           aes(color = factor(substr(AGS, 1, 2))),
#'           size = 1.5) +
